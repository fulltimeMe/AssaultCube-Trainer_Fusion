...
namespace AssaultCubeHack {
    public partial class AssaultHack : Form {
        ...
        private void StartThreads() {
            ...
            //Settings.Default.AimKey
            gkh.HookedKeys.Add(MStuff.myAimKey);
        ...
        private void Draw(Graphics g) {
            ...
            //show player count
            // normal font: font
            g.DrawString("Players: " + numPlayers, MStuff.myFont, new SolidBrush(MStuff.playerTextColor), ClientSize.Width / 2 + 350, 10 + 220);

            g.DrawString(MStuff.name + " " + MStuff.version, MStuff.myFont, new SolidBrush(MStuff.ClientTextColor), ClientSize.Width / 2 + 350, 10 + 200);
            ...
            foreach (Player p in players) {
                ...
                // Settings.Default.TeamColor
                // Settings.Default.EnemyColor
                int offset = 20;
                Pen color = p.Team == self.Team ? new Pen(MStuff.TeamC) : new Pen(MStuff.EnemyC);
